...
execute_bench $QUERIES_PATH/djpeg.smt2               $SEED_PATH/not_kitty.jpeg     djpeg    $OUT_DIR
execute_bench $QUERIES_PATH/jhead.smt2               $SEED_PATH/not_kitty.jpeg     jhead    $OUT_DIR
