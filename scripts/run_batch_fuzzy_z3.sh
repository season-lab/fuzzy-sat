...
BIN_Z3=$SCRIPTPATH/../build/bin/stats-collection-z3
BIN_FUZZY=$SCRIPTPATH/../build/bin/stats-collection-fuzzy
# QUERIES_PATH=$SCRIPTPATH/../query_db/without_models
QUERIES_PATH=/media/luca/HD2T/Home/Data/smt2_queries_dataset/queries_dataset
# SEED_PATH=$SCRIPTPATH/../query_db/seeds
SEED_PATH=/media/luca/HD2T/Home/Data/smt2_queries_dataset/seeds
...
OUT_DIR=/media/luca/HD2T/Home/Data/exp_logs_fuzzy_sat/fuzzy-z3-1sec
