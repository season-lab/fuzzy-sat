                                ...
                                unsigned long unkn_queries_z3)
{
    ...
    pp_printf(7, 1, "L4_flip1:             %ld", fctx.stats.L4_flip1);
    pp_printf(8, 1, "L4_flip2:             %ld", fctx.stats.L4_flip2);
    pp_printf(9, 1, "L4_flip4:             %ld", fctx.stats.L4_flip4);
    pp_printf(10, 1, "L4_flip8:             %ld", fctx.stats.L4_flip8);
    pp_printf(11, 1, "L4_flip16:            %ld", fctx.stats.L4_flip16);
    pp_printf(12, 1, "L4_flip32:            %ld", fctx.stats.L4_flip32);
    pp_printf(13, 1, "L4_arith8_sum:        %ld", fctx.stats.L4_arith8_sum);
    pp_printf(14, 1, "L4_arith8_sub:        %ld", fctx.stats.L4_arith8_sub);
    pp_printf(15, 1, "L4_arith16_sum_LE:    %ld", fctx.stats.L4_arith16_sum_LE);
    pp_printf(16, 1, "L4_arith16_sum_BE:    %ld", fctx.stats.L4_arith16_sum_BE);
    pp_printf(17, 1, "L4_arith16_sub_LE:    %ld", fctx.stats.L4_arith16_sub_LE);
    pp_printf(18, 1, "L4_arith16_sub_BE:    %ld", fctx.stats.L4_arith16_sub_BE);
    pp_printf(19, 1, "L4_arith32_sum_LE:    %ld", fctx.stats.L4_arith32_sum_LE);
    pp_printf(20, 1, "L4_arith32_sum_BE:    %ld", fctx.stats.L4_arith32_sum_BE);
    pp_printf(21, 1, "L4_arith32_sub_LE:    %ld", fctx.stats.L4_arith32_sub_LE);
    pp_printf(22, 1, "L4_arith32_sub_BE:    %ld", fctx.stats.L4_arith32_sub_BE);
    pp_printf(23, 1, "L4_int8:              %ld", fctx.stats.L4_int8);
    pp_printf(24, 1, "L4_int16:             %ld", fctx.stats.L4_int16);
    pp_printf(25, 1, "L4_int32:             %ld", fctx.stats.L4_int32);
    pp_printf(26, 1, "L5_havoc:             %ld", fctx.stats.L5_havoc);
